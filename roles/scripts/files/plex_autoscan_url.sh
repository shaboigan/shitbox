...
# Config files
readonly SB_ANSIBLE="/srv/git/shitbox/ansible.cfg"
readonly SB_ACCOUNTS="/srv/git/shitbox/accounts.yml"
...
${GREEN}│ URL:               https://github.com/shaboigan/Shitbox                            │
...
function build_url() {
    ...
    # Get variables from Shitbox account settings
